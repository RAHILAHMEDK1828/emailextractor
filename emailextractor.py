...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract emails from a domain one level deep.")
    parser.add_argument(
        "-c", "--concurrent",
        type=int,
        default=30,
        help="Number of concurrent URL fetches (default: 30)"
    )
    parser.add_argument(
        "-t", "--timeout",
        type=int,
